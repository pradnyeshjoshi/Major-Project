...
nn = Classifier(layers = [Layer("Maxout", units=100, pieces=2), Layer("Softmax")], learning_rate=0.001, n_iter=500)
nn.fit(train_centroids, train_output)

result = nn.predict(test_centroids)
